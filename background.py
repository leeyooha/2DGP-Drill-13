...
class InfiniteBackground:
    ...
    def __init__(self):
        ...
        self.window_left = 0  # 기본 값 추가
        self.window_bottom = 0  # 기본 값 추가
    ...
    def update(self):
        ...
        self.window_left = clamp(0, int(server.boy.x) - self.cw // 2, self.w - self.cw)
        self.window_bottom = clamp(0, int(server.boy.y) - self.ch // 2, self.h - self.ch)
